...
export const BLOCK_TYPES = {
  ...
  container: {
    label: "Container (Columns / Layout)",
    icon: "LayoutGrid",
    description: "Wrap multiple sections side-by-side or stacked with responsive layout controls",
    defaults: {
      layout: "grid-2",
      direction: "normal",
      reverseMobile: false,
    ...
    fields: [
      ...
      },
      {
        key: "reverseMobile",
        type: "boolean",
        label: "Reverse order on mobile screens",
      },
      { key: "gap", type: "text", label: "Gap between items (px)" },
      {
        key: "maxWidth",
        type: "select",
        label: "Maximum container width",
        options: ["full", "7xl", "6xl", "5xl", "4xl", "prose"],
      },
      {
        key: "align",
        type: "select",
      ...
      { key: "border", type: "boolean", label: "Show border" },
      {
        key: "shadow",
        type: "select",
        label: "Shadow",
  ...
  registrationForm: {
    ...
    icon: "Type",
    description: "Configurable student course registration with validation and intake management",
    defaults: {
      defaultCourse: "",
      courseQueryParam: "course",
      allowChangeCourse: true,
      allowFlexibleIntake: true,
      submitLabel: "Submit Registration Request",
      paymentNotice: "Our training team will review your application and confirm your enrollment place.",
      successTitle: "Registration Received!",
      successMessage: "Thank you for registering. Our team will verify your submission and confirm your enrollment.",
      enableStripe: true,
      showReceiptUpload: true,
    },
    fields: [
      { key: "defaultCourse", type: "text", label: "Fixed default course ID or slug (optional)" },
      { key: "courseQueryParam", type: "text", label: "URL query parameter for course", default: "course" },
      { key: "allowChangeCourse", type: "boolean", label: "Allow visitor to change course" },
      { key: "allowFlexibleIntake", type: "boolean", label: "Allow flexible intake (next available batch)" },
      { key: "submitLabel", type: "text", label: "Submit button text" },
      { key: "paymentNotice", type: "textarea", label: "Notice under submit button" },
      { key: "successTitle", type: "text", label: "Success title" },
      { key: "successMessage", type: "textarea", label: "Success message" },
      { key: "showReceiptUpload", type: "boolean", label: "Show bank receipt upload when bank transfer is chosen" },
      { key: "enableStripe", type: "boolean", label: "Enable Stripe card payment when configured" },
    ],
  },
  ...
  bankPaymentDetails: {
    ...
    icon: "BadgeDollarSign",
    description: "Display official bank account details, instructions, copy buttons, and QR code",
    defaults: {
      title: "Bank Transfer Details",
      instructions: "Please include your full name or registration reference in the transfer description.",
      ...
      currency: "£",
      qrCodeImage: "",
      footnote: "Transfers typically take 1-2 business days to clear.",
    },
    fields: [
      { key: "title", type: "text", label: "Section title" },
      { key: "instructions", type: "textarea", label: "Introductory instructions" },
      { key: "useOwnerSettings", type: "boolean", label: "Use website owner's bank account settings" },
      { key: "bankName", type: "text", label: "Bank name (if not using owner settings)" },
      { key: "accountTitle", type: "text", label: "Account title (if not using owner settings)" },
      { key: "accountNumber", type: "text", label: "Account number" },
      { key: "iban", type: "text", label: "IBAN" },
      { key: "sortCode", type: "text", label: "Sort code" },
      { key: "swiftBic", type: "text", label: "SWIFT / BIC" },
      { key: "showCopyButtons", type: "boolean", label: "Show copy-to-clipboard buttons" },
      { key: "showAmountDue", type: "boolean", label: "Show amount due" },
      { key: "amountDue", type: "text", label: "Amount due (fixed or variable like {{course.price}})" },
      { key: "currency", type: "text", label: "Currency symbol", default: "£" },
      { key: "qrCodeImage", type: "image", label: "Payment QR code image (optional)" },
      { key: "footnote", type: "text", label: "Footnote note" },
    ],
  },
  ...
  container: {
    ...
    icon: "Columns2",
    description: "Multi-column / composable layout container for wrapping sections",
    defaults: {
      layout: "grid-2",
      direction: "normal",
      reverseMobile: false,
    ...
    fields: [
      {
        ...
        label: "Column Layout",
        options: [
          { value: "grid-2", label: "2 Equal Columns (50 / 50)" },
          { value: "60-40", label: "2 Columns (60% / 40%)" },
          { value: "40-60", label: "2 Columns (40% / 60%)" },
          { value: "1fr-360px", label: "Wide Content + 360px Sidebar" },
          { value: "360px-1fr", label: "360px Sidebar + Wide Content" },
          { value: "grid-3", label: "3 Equal Columns" },
          { value: "stacked", label: "Vertical Stack" },
          { value: "flex-row", label: "Flexible Row" },
        ],
      },
      {
        key: "direction",
        ...
        options: [
          { value: "normal", label: "Normal (Left to Right / Top to Bottom)" },
          { value: "reverse", label: "Reversed (Right to Left / Bottom to Top)" },
        ],
      },
      { key: "reverseMobile", type: "boolean", label: "Reverse stacking order on mobile devices" },
      { key: "gap", type: "text", label: "Column Gap (px)" },
      { key: "paddingX", type: "text", label: "Horizontal Padding (px)" },
      { key: "paddingY", type: "text", label: "Vertical Padding (px)" },
      {
        key: "maxWidth",
        type: "select",
        ...
        options: [
          ...
          { value: "prose", label: "Readable (65ch)" },
        ],
      },
      {
        key: "align",
        ...
        options: [
          { value: "stretch", label: "Stretch to Match Height" },
      ...
      },
      {
        ...
        options: [
          ...
          { value: "subtle", label: "Subtle Grey" },
          { value: "solid", label: "Custom Solid Color" },
        ],
      },
      { key: "bgColor", type: "color", label: "Background Color (when Solid)" },
      { key: "border", type: "boolean", label: "Border around container" },
      {
        key: "radius",
        type: "select",
        label: "Corner Radius",
        options: [
          { value: "none", label: "Square (None)" },
          { value: "sm", label: "Small" },
          { value: "md", label: "Medium" },
          { value: "lg", label: "Large" },
          { value: "xl", label: "Extra Large (16px)" },
          { value: "2xl", label: "Rounded (24px)" },
        ],
      },
      {
        key: "shadow",
  ...
  registrationForm: {
    label: "Candidate Registration Form",
    icon: "UsersRound",
    description: "Interactive candidate registration form with intake selection, receipt upload & Stripe",
    defaults: {
      title: "Enroll in Course",
      subtitle: "Complete the form below to register your seat for the upcoming batch.",
      courseSource: "url",
      defaultCourseId: "",
      courseQueryParam: "course",
      allowChangeCourse: true,
      ...
      successMessage: "Thank you for registering! Our training team will review your application.",
      showFieldCompany: true,
      showFieldJobTitle: true,
      showFieldAddress: true,
      showFieldCity: true,
    ...
    fields: [
      ...
      { key: "subtitle", type: "textarea", label: "Form Subtitle" },
      {
        key: "courseSource",
        type: "select",
        label: "Course Selection Source",
        options: [
          { value: "url", label: "Read from URL query parameter (e.g. ?course=slug-or-id)" },
          { value: "fixed", label: "Fixed course (specified below)" },
          { value: "variable", label: "Dynamic CMS Variable binding" },
        ],
      },
      { key: "defaultCourseId", type: "text", label: "Fixed Default Course ID or Slug" },
      { key: "courseQueryParam", type: "text", label: "URL Query Param Name (default: 'course')" },
      { key: "allowChangeCourse", type: "boolean", label: "Allow visitor to change preselected course" },
      { key: "fallbackCourseId", type: "text", label: "Fallback Course (if URL course is invalid/missing)" },
      { key: "allowFlexibleIntake", type: "boolean", label: "Allow 'Next Available Batch / Flexible' intake option" },
      { key: "enableBankTransfer", type: "boolean", label: "Enable Bank Transfer with Receipt Upload" },
      { key: "enableStripe", type: "boolean", label: "Enable Direct Stripe Card Payment" },
      { key: "submitButtonText", type: "text", label: "Submit Button Text" },
      { key: "successMessage", type: "textarea", label: "Success Message" },
      { key: "showFieldCompany", type: "boolean", label: "Show Company Name field" },
      { key: "showFieldJobTitle", type: "boolean", label: "Show Job Title field" },
      { key: "showFieldAddress", type: "boolean", label: "Show Street Address field" },
      { key: "showFieldCity", type: "boolean", label: "Show City field" },
      { key: "showFieldCountry", type: "boolean", label: "Show Country field" },
      { key: "showFieldNotes", type: "boolean", label: "Show Notes / Special Requirements field" },
      { key: "accent", type: "color", label: "Accent / Button Color" },
      {
        key: "cardStyle",
        type: "select",
        label: "Card Container Style",
        options: [
          { value: "card", label: "White elevated card with border" },
  ...
  bankPaymentDetails: {
    label: "Bank Payment Details",
    icon: "BadgeDollarSign",
    description: "Display bank account details, IBAN, instructions and QR code for direct transfers",
    defaults: {
      title: "Bank Transfer Details",
      subtitle: "Transfer the course fee to our official bank account and upload your payment receipt.",
      ...
      branchCode: "",
      swiftCode: "",
      instructions: "Please mention candidate full name or registration ID in transfer remarks.",
      showQr: true,
      qrImage: "",
      accent: "#2563eb",
      cardStyle: "card",
    ...
    fields: [
      ...
      { key: "subtitle", type: "textarea", label: "Section Subtitle" },
      {
        key: "source",
        type: "select",
        label: "Bank Information Source",
        options: [
          { value: "owner_settings", label: "Load automatically from Owner Organization Settings" },
          { value: "custom", label: "Custom details specified below" },
        ],
      },
      { key: "bankName", type: "text", label: "Bank Name (when custom)" },
      { key: "accountTitle", type: "text", label: "Account Title (when custom)" },
      { key: "accountNumber", type: "text", label: "Account Number (when custom)" },
      { key: "iban", type: "text", label: "IBAN (when custom)" },
      { key: "branchCode", type: "text", label: "Branch Code (when custom)" },
      { key: "swiftCode", type: "text", label: "SWIFT / BIC Code (when custom)" },
      { key: "instructions", type: "textarea", label: "Payment Instructions" },
      { key: "showQr", type: "boolean", label: "Show QR Code" },
      { key: "qrImage", type: "image", label: "QR Code Image (optional)" },
...
// Blocks that hold other blocks (repeater and composable container).
export const CONTAINER_TYPES = new Set(["repeater", "container"]);
