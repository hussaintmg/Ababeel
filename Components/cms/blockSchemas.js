...
export const BLOCK_TYPES = {
  ...
  scrollVideo: {
    ...
    fields: [
      ...
      { group: "Scroll behaviour", key: "pxPerFrame", type: "text", label: "Scroll per frame (px)", help: "Only used when the scroll distance is left on auto." },
      ...
      { group: "Scroll behaviour", key: "sticky", type: "boolean", label: "Pin the stage while scrolling" },
      {
        group: "Scroll behaviour",
        key: "lockScroll",
        type: "boolean",
