...
import { publicPageBlocks } from "@/Components/cms/publicPages/catalog";
import { MODERN_FULL_PAGES } from "@/Components/cms/publicPageSections";
...
const PAGE_TEMPLATE_MAP = {
  home: "pub-page-home-complete",
  "about-us": "pub-page-about-complete",
  "contact-us": "pub-page-contact-complete",
  qualification: "pub-page-qualifications-complete",
  courses: "pub-page-courses-complete",
  "course-detail": "pub-page-course-detail-complete",
  schedule: "pub-page-schedule-complete",
  registration: "pub-page-registration-complete",
  resources: "pub-page-resources-complete",
  "resource-detail": "pub-page-resource-detail-complete",
  "awarding-bodies": "pub-page-awarding-bodies-complete",
  "our-team": "pub-page-team-complete",
  "our-consultants": "pub-page-consultants-complete",
  accreditations: "pub-page-accreditations-complete",
  faqs: "pub-page-faqs-complete",
  "professional-dev": "pub-page-professional-complete",
  partner: "pub-page-partner-complete",
  "verify-certificate": "pub-page-verify-certificate-complete",
  "privacy-policy": "pub-page-privacy-policy-complete",
  "terms-of-services": "pub-page-terms-complete",
  "refund-policy": "pub-page-refund-policy-complete",
  "logo-use": "pub-page-logo-use-complete",
  "glossary-of-terms": "pub-page-glossary-complete",
};

function getModernPageBlocks(key) {
  const tplId = PAGE_TEMPLATE_MAP[key];
  if (!tplId) return null;
  const tpl = MODERN_FULL_PAGES.find((p) => p.id === tplId);
  if (!tpl || !Array.isArray(tpl.blocks) || tpl.blocks.length === 0) return null;
  return tpl.blocks.map((spec) => ({
    id: newId(),
    type: spec.type,
...
export function getDefaultDoc(key) {
  ...
  const modernBlocks = getModernPageBlocks(key);
  const blocks = modernBlocks && modernBlocks.length > 0
    ? modernBlocks
    : publicPageBlocks(key).length
    ? publicPageBlocks(key)
    : starterBlocks(page);
