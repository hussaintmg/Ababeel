...
export const LIMITS = {
  ...
  // Public registration: generous enough for a training team filling in forms
  // on behalf of a group, tight enough that the form is not a spam relay.
  registrationSubmit: { windowMs: 60 * 60 * 1000, maxAttempts: 15 },
  // Owner-side course/session/people edits — a working session saves often.
  trainingAdmin: { windowMs: 60 * 60 * 1000, maxAttempts: 300 },
