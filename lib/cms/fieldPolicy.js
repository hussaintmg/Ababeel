...
export const PUBLIC_FIELD_ALLOWLIST = {
  ...
  Resource: new Set([
    "_id", "title", "name", "slug", "shortDescription", "content", "featuredImage", "image",
    "type", "file", "fileLabel", "externalUrl", "publishedDate", "featured", "status", "displayOrder", "seo", "createdAt", "updatedAt"
  ]),
  TeamMember: new Set([
    "_id", "name", "title", "slug", "position", "profileImage", "image", "bio", "qualifications",
    "certifications", "experience", "email", "socialLinks", "leadership", "status", "displayOrder", "seo", "createdAt", "updatedAt"
  ]),
  Consultant: new Set([
    "_id", "name", "title", "slug", "position", "profileImage", "image", "gallery", "bio", "qualifications",
    "certifications", "experience", "expertise", "socialLinks", "layout", "showCarousel", "textAlign", "animation",
    "featured", "status", "displayOrder", "seo", "createdAt", "updatedAt"
  ]),
  Testimonial: new Set([
    "_id", "name", "title", "profileImage", "image", "reviewText", "text", "rating", "company", "position",
    "reviewDate", "sourceLogo", "sourceName", "verifiedLabel", "sourceUrl", "featured", "status", "displayOrder", "createdAt", "updatedAt"
  ]),
};
...
const DISPLAY_FIELDS = {
  ...
  Resource: 'title slug shortDescription content featuredImage type file fileLabel externalUrl publishedDate featured status displayOrder',
  TeamMember: 'name slug position profileImage bio qualifications certifications experience email socialLinks leadership status displayOrder',
  Consultant: 'name slug position profileImage gallery bio qualifications certifications experience expertise socialLinks layout showCarousel textAlign animation featured status displayOrder',
  Testimonial: 'name profileImage reviewText rating company position reviewDate sourceLogo sourceName verifiedLabel sourceUrl featured status displayOrder',
};
