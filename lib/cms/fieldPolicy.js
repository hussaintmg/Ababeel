...
export const PUBLIC_FIELD_ALLOWLIST = {
  ...
  CourseReference: new Set([
    "_id", "referenceNumber", "referenceName", "referenceCode", "sequenceId", "duration",
    "deliveryMode", "mode", "location", "seats", "category", "description", "shortDescription",
    "thumbnail", "image", "badge", "level", "instructor", "trainerName", "atcName",
