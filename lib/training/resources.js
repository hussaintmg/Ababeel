...
export const RESOURCES = {
  ...
  resources: {
    ...
    Model: Resource,
    slugSource: "title",
    searchFields: ["title", "shortDescription", "type"],
    defaultSort: { displayOrder: 1, publishedDate: -1 },
    listSelect:
      "title slug type featuredImage publishedDate featured status displayOrder updatedAt",
    fields: [
      "title",
      "slug",
      "shortDescription",
