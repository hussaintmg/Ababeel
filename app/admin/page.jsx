...
export default function AdminDashboard() {
  ...
  const fetchDashboardData = async () => {
    setLoading(true);
    try {
      await Promise.all([fetchCoursesCount(), fetchOrgsCount()]);
    } catch (error) {
  ...
  useEffect(() => {
    fetchDashboardData();
    document.title = `Admin | ${webData.brand.name}`;
  }, []);
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              ...
              <span className="font-semibold text-gray-800">
                {user?.username?.split(/[\s\-_]/)[0] || "Admin"}
              </span>
            </p>
          </div>
          <button
      ...
      <main className="p-4 md:p-6 lg:p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6">
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 font-medium">My Organizations</p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => router.push("/admin/default-course/all")}
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-gray-600 text-sm mb-4">Edit and update training courses</p>
            ...
            >
              ...
              <p className="text-gray-600 text-sm mb-4">View your created organizations</p>
              <div className="flex items-center text-blue-600 font-medium text-sm">
                <span>Access now</span>
                <svg className="w-4 h-4 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
