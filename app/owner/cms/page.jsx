    ...
    <div className="max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div className="flex items-start gap-3 min-w-0">
          <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 text-white flex items-center justify-center shadow-sm shrink-0">
            <LayoutTemplate size={20} className="sm:w-[22px] sm:h-[22px]" />
          </div>
          <div className="min-w-0 flex-1">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Website CMS</h1>
        ...
        <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap shrink-0">
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl border border-gray-200 bg-white text-xs sm:text-sm font-medium text-gray-700 hover:border-blue-400 hover:text-blue-600 transition-colors flex-1 sm:flex-initial"
            title="Every field discovered from your database, ready to bind into pages"
          >
            <Layers size={16} /> Variables &amp; Data
          </Link>
          <button
            onClick={() => setShowCreate(true)}
            className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 text-white text-xs sm:text-sm font-medium shadow-sm hover:shadow-md hover:scale-[1.02] transition-all flex-1 sm:flex-initial"
          >
                  ...
                  return (
                    ...
                    >
                      <Link
                        ...
                        className="group block h-full rounded-2xl border border-gray-200 bg-white p-5 hover:border-blue-400 hover:shadow-lg transition-all min-w-0"
                      >
                        ...
                        <h3 className="mt-4 font-semibold text-gray-900 group-hover:text-blue-600 transition-colors truncate">
                          {p.title}
                        </h3>
                        <p className="text-xs text-gray-400 mt-0.5 truncate">{p.description || p.route}</p>
