    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Owner Page...</p>
        </div>
      </div>
    );
  }
        ...
        <CourseProvider>
              ...
              {mobileSidebarOpen && (
                <div
                  ...
                  onClick={() => setOwnerSideBarOpen(false)}
                />
              )}
              ...
              <div className="flex">
                ...
                <Sidebar
                  ...
                  mobileOpen={ownerSideBarOpen}
                  setMobileOpen={setOwnerSideBarOpen}
                  menuItems={menuItems}
                />
                {/* Main Content */}
                <main
